...
void Combat::monsterTurn() {
    ...
    // Consomme l'usure de l'armure si elle est equipee et que le monstre attaque
    // (on ne conditionne pas sur reduction > 0 car la division entiere peut donner 0)
    if (multi >= 0.3f && player.getArmureEquipee()) {
